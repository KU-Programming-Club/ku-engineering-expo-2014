...
public class DatabaseManager {
	...
	public static final String ACTION_SCHEDULE_REFRESHED = "edu.kuacm.expo.action.SCHEDULE_REFRESHED";
	public static final String ACTION_ADD_BOOKMARK = "edu.kuacm.expo.action.ADD_BOOKMARK";
	public static final String EXTRA_EVENT_ID = "event_id";
	public static final String EXTRA_EVENT_START_TIME = "event_start";
	public static final String ACTION_REMOVE_BOOKMARKS = "bedu.kuacm.expo.action.REMOVE_BOOKMARKS";
	public static final String EXTRA_EVENT_IDS = "event_ids";

	private static final Uri URI_TRACKS = Uri.parse("sqlite://edu.kuacm.expo/tracks");
	private static final Uri URI_EVENTS = Uri.parse("sqlite://edu.kuacm.expo/events");
